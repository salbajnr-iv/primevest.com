...
-- Canonical asset catalog seed used by /api/market/list.

insert into assets (id, symbol, name, status, category, type, metadata) values
...
('stock-msft', 'MSFT', 'Microsoft', 'active', 'stocks', 'equity', '{"iconSrc":"https://logo.clearbit.com/microsoft.com","marketCap":2810000000000,"volume24h":21000000,"baselinePrice":378.91}'::jsonb),
('stock-amzn', 'AMZN', 'Amazon', 'active', 'stocks', 'equity', '{"iconSrc":"https://logo.clearbit.com/amazon.com","marketCap":1600000000000,"volume24h":35000000,"baselinePrice":155.34}'::jsonb),
('stock-nvda', 'NVDA', 'NVIDIA', 'active', 'stocks', 'equity', '{"iconSrc":"https://logo.clearbit.com/nvidia.com","marketCap":1220000000000,"volume24h":42000000,"baselinePrice":495.22}'::jsonb),
