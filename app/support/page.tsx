...
=======
  const [showChat预告, setShowChat预告] = React.useState(false);
>>>>>>> 02bdcb7 (Initial commit)
...
=======
        ...
        <section className="support-actions">
          ...
          <div className="support-actions-grid">
            <button className="support-action-card" onClick={() => setShowChat预告(true)}>
            ...
            <Link href="mailto:support@example.com" className="support-action-card">
              <div className="support-action-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
                  <polyline points="22,6 12,13 2,6" />
            ...
            <Link href="/faq" className="support-action-card">
              <div className="support-action-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="10" />
                  <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" />
              ...
              <span>FAQs</span>
              <small>Browse FAQs</small>
            </Link>
            <Link href="/helpcenter" className="support-action-card">
              <div className="support-action-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" />
                  <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" />
...
=======
      {showChat预告 && (
        <div className="modal-overlay" onClick={() => setShowChat预告(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3>Live Chat</h3>
              <button className="modal-close" onClick={() => setShowChat预告(false)}>
>>>>>>> 02bdcb7 (Initial commit)
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
=======
              <button className="bp-button bp-button-secondary" onClick={() => setShowChat预告(false)}>
                Close
              </button>
              <a href="mailto:support@example.com" className="bp-button bp-button-primary">
>>>>>>> 02bdcb7 (Initial commit)
                Contact via Email
              </a>
            </div>
