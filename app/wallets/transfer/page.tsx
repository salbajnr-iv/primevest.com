...
export default function TransferPage() {
  ...
  const handleTransfer = () => {
    ...
    if (parseFloat(amount) > availableBalances[selectedCurrency as keyof typeof availableBalances]) {
        ...
        <section className="quick-transfer">
          ...
          <div className="transfer-form">
            ...
            <div className="form-group">
              ...
              >
                <option value="EUR">EUR (€{availableBalances.EUR.toLocaleString('de-DE', { minimumFractionDigits: 2 })})</option>
            ...
            <div className="form-group">
              ...
              <input
                ...
                max={availableBalances[selectedCurrency as keyof typeof availableBalances]}
              ...
              <div className="balance-hint">
                Available: {
                  ...
                  availableBalances[selectedCurrency as keyof typeof availableBalances].toLocaleString('de-DE', { 
