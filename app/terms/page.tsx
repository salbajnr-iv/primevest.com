      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-16">
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-lg p-8 text-gray-300 space-y-6">
          ...
          <section>
            ...
            <p>Permission is granted to temporarily download one copy of the materials (information or software) on PrimeVest Capital for personal, non-commercial transitory viewing only.
          ...
          <section>
            ...
            <p>
              The materials on PrimeVest Capital are provided on an 'as is' basis. PrimeVest Capital makes no warranties, expressed or implied,
          ...
          <section>
            ...
            <p>
              The materials appearing on PrimeVest Capital could include technical, typographical, or photographic errors.
              PrimeVest Capital does not warrant that any of the materials on our website are accurate, complete, or current.
              PrimeVest Capital may make changes to the materials contained on its website at any time without notice.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              PrimeVest Capital has not reviewed all of the sites linked to our website and is not responsible for the contents of any such linked site.
              The inclusion of any link does not imply endorsement by PrimeVest Capital of the site. Use of any such linked website is at the user's own risk.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              PrimeVest Capital may revise these terms and conditions for its website at any time without notice.
