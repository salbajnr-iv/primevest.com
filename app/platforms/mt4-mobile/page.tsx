...
export default function MT4MobilePage() {
  const handleAppStore = () => {
    window.open("https://apps.apple.com/app/metatrader-4", "_blank");
  };
  ...
  const features = [
    {
      ...
      desc: "Access global markets from your smartphone or tablet with the same powerful tools as the desktop version",
      icon: "📱"
    },
    {
      title: "Real-Time Charts",
      desc: "Professional charting with 30+ technical indicators and multiple timeframes at your fingertips",
      icon: "📊"
    },
    {
      title: "Instant Execution",
      desc: "Execute trades instantly with one-tap order placement and real-time market updates",
      icon: "⚡"
    },
    {
      title: "Push Notifications",
      desc: "Stay informed with real-time alerts for price movements, news, and market events",
      icon: "🔔"
    },
    {
      title: "Offline Mode",
      desc: "Access your charts and market data even without an internet connection",
      icon: "📶"
    },
    {
      title: "Multi-Device Sync",
      desc: "Seamlessly switch between mobile, desktop, and web platforms with synchronized data",
      icon: "🔄"
    }
  ];

  const appFeatures = [
    { name: "iOS App", platform: "iPhone, iPad", version: "Latest" },
    { name: "Android App", platform: "Phones, Tablets", version: "Latest" },
    { name: "Web Mobile", platform: "Mobile Browser", version: "Responsive" }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 text-gray-900 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="space-y-6">
                ...
                >
                  Take your trading anywhere with the mobile version of MetaTrader 4. 
                  Professional tools, real-time data, and instant execution on your smartphone or tablet.
                </motion.p>
              </div>
              ...
              >
                <div className="flex items-center gap-3 bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-gray-200 shadow-sm group hover:shadow-md transition-all duration-300 transition-professional">
                  ...
                  <span className="text-sm text-gray-700 font-medium group-hover:text-emerald-600 transition-colors">iOS & Android</span>
                </div>
                <div className="flex items-center gap-3 bg-white/80 backdrop-blur-sm rounded-xl p-4 border border-gray-200 shadow-sm group hover:shadow-md transition-all duration-300 transition-professional">
                  <div className="w-3 h-3 bg-emerald-500 rounded-full animate-pulse group-hover:animate-ping"></div>
                  <span className="text-sm text-gray-700 font-medium group-hover:text-emerald-600 transition-colors">Real-time Trading</span>
                </div>
              </motion.div>
            </motion.div>
                      ...
                      <div className="w-full h-full bg-gray-800 rounded-2xl overflow-hidden relative">
                        ...
                        <div className="pt-6 h-full flex flex-col">
                          ...
                          <div className="px-3 py-2 bg-gray-900 flex items-center justify-between">
                            ...
                            <span className="text-white text-xs">MT4</span>
                          </div>
                          ...
                          <div className="flex-1 bg-gray-700 relative overflow-hidden">
                            <div className="absolute inset-0">
                              <svg viewBox="0 0 150 200" className="w-full h-full">
                                <path 
                                  d="M 0 120 Q 20 100 40 110 T 80 90 T 120 80 T 150 90" 
                                  stroke="#10b981" 
                                  strokeWidth="2" 
                                  fill="none"
                                />
                                <path 
                                  d="M 0 120 Q 20 100 40 110 T 80 90 T 120 80 T 150 90 L 150 200 L 0 200 Z" 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-body text-gray-600 max-w-3xl mx-auto transition-professional">
              Everything you need for professional mobile trading in a sleek, intuitive interface
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-body text-gray-600 transition-professional">
              Trade on any device with our optimized mobile solutions
            </p>
          </motion.div>
                  ...
                  <div className="relative z-10">
                    <div className="w-20 h-20 rounded-2xl bg-gray-100 flex items-center justify-center mx-auto mb-6 group-hover:bg-emerald-100 transition-colors duration-300">
                      <span className="text-4xl">
                        {app.name.includes('iOS') ? '📱' : app.name.includes('Android') ? '🤖' : '🌐'}
                      </span>
                    </div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-emerald-600 transition-colors duration-300 transition-professional">{app.name}</h3>
                    <p className="text-gray-600 mb-2">{app.platform}</p>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Never miss a trading opportunity. Download MT4 Mobile and access global markets from anywhere, anytime.
          </motion.p>
          <motion.div 
            variants={fadeInUp}
